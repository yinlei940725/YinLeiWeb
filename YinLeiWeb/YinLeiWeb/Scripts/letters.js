    ...
    initAlphabet: function(weight, rounded){
        ...
        this.alphabet = {
            ...
            'i': {
                ...
                paths: [lineCenter, lineCenter],
                initial: [{begin: '1', end: '1'}, {begin: '50%', end: '50%'}],
                final: [{begin: '20%', end: '20%'}, {begin: p50minus23, end: p50plus23}]
            },
            'j': {
                svg: svgFJRT,
                paths: [circleJ, lineJ],
            ...
            'n': {
                svg: svgSmall,
                paths: [circleCenter, lineLeft, lineRight],
                initial: [{ begin: '-60%', end: '-60%' }, { begin: '90%', end: '90%' }, { begin: '50%', end: '50%' }],
                final: [{ begin: '-25%', end: '25%' }, { begin: p50minus23, end: p50plus23 }, { begin: '68%', end: '50%' }]
            },
            'o': {
                svg: svgSmall,
                paths: [circleCenter],
            ...
            'y': {
                ...
                final: [{ begin: '-75%', end: '-25%' }, { begin: '25% - 1', end: '50%' }, { begin: p50minus23, end: p50plus23 }]
            },
            'z': {
                svg: svgSXZ,
                paths: [circleSXZ, circleSXZ2],
